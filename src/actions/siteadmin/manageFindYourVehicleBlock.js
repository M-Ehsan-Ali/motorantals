...
export function manageFindYourVehicleBlock(values, formatMessage) {
    ...
    return async (dispatch, getState, { client }) => {
        ...
        try {
            ...
            if (data.updateFindYourBlock.status === 200) {
                toastr.success(formatMessage(messages.commonSuccess), formatMessage(messages.changesUpdateSuccess));
