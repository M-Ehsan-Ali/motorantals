...
export function doUpdateImageBanner(values, formatMessage) {
    ...
    return async(dispatch, getState, {client}) => {
        ...
        try {
            ...
            if (data.updateImageBanner.status === "success") {
                toastr.success(formatMessage(messages.updateBannerSettings), formatMessage(messages.changesUpdateSuccess));
