...
export function addListToRecommended(listId, currentPage, searchList, formatMessage) {
  ...
  return async (dispatch, getState, { client }) => {
    ...
    try {
      ...
      if(data.addRecommend.status === "success") {
        ...
        toastr.success(formatMessage(messages.commonSuccess), formatMessage(messages.listAddedToRecomended));
      } else {
          dispatch({
...
export function removeListFromRecommended(listId, currentPage, searchList, formatMessage) {
  ...
  return async (dispatch, getState, { client }) => {
    ...
    try {
      ...
      if(data.removeRecommend.status === "success") {
        ...
        toastr.success(formatMessage(messages.commonSuccess), formatMessage(messages.listRemovedFromRecomended));
      } else {
          dispatch({
