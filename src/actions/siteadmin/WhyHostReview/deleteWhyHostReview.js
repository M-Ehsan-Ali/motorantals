...
export function deleteWhyHostReview({ reviewId, formatMessage }) {
    ...
    return async (dispatch, getState, { client }) => {
        ...
        try {
            ...
            if (data && data.deleteWhyHostReview.status === 200) {
                ...
                toastr.error(formatMessage(messages.commonError), data && data.deleteWhyHostReview.errorMessage);
            }
...
export function updateReview(values, formatMessage) {
    ...
    return async (dispatch, getState, { client }) => {
        ...
        try {
            ...
            if (data && data.updateWhyHostReview.status === 200) {
                ...
                toastr.success(formatMessage(messages.commonSuccess), formatMessage(messages.reviewUpdateSuccess));
                history.push('/siteadmin/reviews');
            } else {
                toastr.error(formatMessage(messages.commonError), data && data.updateWhyHostReview.errorMessage);
            }
