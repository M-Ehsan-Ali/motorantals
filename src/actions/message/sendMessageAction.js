  ...
  return async (dispatch, getState, { client }) => {
    try {
      ...
      if (
        data &&
        data.sendMessage &&
        data.sendMessage.status == "alreadyPerformed"
      ) {
        toastr.error(
          formatMessage(messages.commonError),
          formatMessage(messages.actionAlreadyPerformed)
        );
        dispatch({
        ...
        data &&
        data.sendMessage &&
        data.sendMessage.status != "userbanned"
      ) {
        ...
        if (type === "message") {
          ...
          sendEmail(receiverEmail, "message", emailContent, intl);
        }
      }
