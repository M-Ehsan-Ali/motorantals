...
class VerifyOwner extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    const { userType: prevUserType } = prevProps;
    const { userType: currentUserType, change } = this.props;

    if (prevUserType === "Company" && currentUserType === "Individual") {
      change("personName", "");
          ...
          <form onSubmit={handleSubmit} className={s.form}>
            <div className={s.landingMainContent}>
              ...
              <FormGroup className={s.formGroup}>
                <ControlLabel className={s.landingLabel}>
                  <FormattedMessage
                    {...messages[isCompany ? "fullCompanyName" : "fullName"]}
                  />
                </ControlLabel>
                <Field
                  name="name"
              ...
              <FormGroup className={s.formGroup}>
                <ControlLabel className={s.landingLabel}>
                  <FormattedMessage
                    {...messages[
                      isCompany ? "fullCompanyAddress" : "yourFullAddress"
                    ]}
                  />
                </ControlLabel>
                <Field
              ...
              <FormGroup className={s.formGroup}>
                <ControlLabel className={s.landingLabel}>
                  {isCompany ? (
                    <FormattedMessage {...messages.companyRegDocument} />
                  ) : (
                    <FormattedMessage {...messages.nationalIdPassport} />
                  )}
                </ControlLabel>
                <DocumentUpload
                  mark={isCompany ? "company_registration" : "passport"}
                  placeholder={formatMessage(
                    messages.documentUploadPlaceholder
                  )}
              ...
              {userTypeValue === "Company" && (
                <>
                  ...
                  <FormGroup className={s.formGroup}>
                    <ControlLabel className={s.landingLabel}>
                      <FormattedMessage {...messages["yourFullAddress"]} />
                    </ControlLabel>
                    <Field
                      name="personAddress"
                      component={CommonFormComponent}
...
export default injectIntl(
  withStyles(s, cs)(connect(mapState, mapDispatch)(VerifyOwner))
);
