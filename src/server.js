...
import profilePictureUpload from "./core/profilePictureUpload";
...
app.use(
  cors({
    origin: [
      ...
      "https://www.octal-nodejs-959e0f23ca0e.herokuapp.com/",
