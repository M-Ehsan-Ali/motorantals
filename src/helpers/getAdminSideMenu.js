...
import ownerVerificationIcon from '/public/AdminIcons/ownerVerification.svg'
...
export function getAdminSideMenu(formatMessage, location) {
    ...
    let sideMenuData3 = [
        ...
        {
            menuLocation: "/siteadmin/owner-verification",
            menuName: formatMessage(messages.ownerVerificaiton),
            activeLocation: (location === "/siteadmin/owner-verification"),
            icon: ownerVerificationIcon,
            iconAltText: 'ownerVerificationIcon',
            isValidatePrivilege: true,
            privilegeId: 21
        },
        {
