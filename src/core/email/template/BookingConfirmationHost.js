...
class BookingConfirmationHost extends React.Component {
  ...
  render() {
    ...
    const {
      content: { reservationId, threadId },
    } = this.props;
    const {
      content: {
        guestName,
    ...
    let checkInDateShort =
      checkIn != null ? moment(checkIn).format("Do MMMM") : "";
    let guestJoinedYear =
      guestJoinedDate != null ? moment(guestJoinedDate).format("YYYY") : "";
              ...
              <TR>
                <TD style={textStyle}>
                  ...
                  <h1 style={bookingTitle}>
                    <FormattedMessage {...messages.newRideConfimed} /> <br />
                    <span>
                      `${guestName} ${formatMessage(messages.arrives)}`
                    </span>{" "}
                    <br />
                  ...
                  <EmptySpace height={20} />
                  <div>
                    `${formatMessage(messages.msgConfirmpickupDetails)} $
                    {guestName}.`
                  </div>
                  <EmptySpace height={20} />
                  <div>
                  ...
                  <div>
                    ...
                    <br />
                    <EmptySpace height={5} />
                    <span>{guestLocation}</span>
                    <br />
                    <EmptySpace height={5} />
                    <span>
                      `${sitename} ${formatMessage(messages.memberSince)} $
                      {guestJoinedYear}`
                    </span>
                  </div>
                  ...
                  <div>
                    <a href={messageURL} style={buttonStyle}>
                      <FormattedMessage {...messages.contactRenter} />
                    </a>
                  </div>
            ...
            <TBody>
              <TR style={textStyle}>
                <TD style={space}>
                  ...
                  <br />
                  <EmptySpace height={1} />
                  <span>{formatTime(allowedCheckInTime)}</span>
                </TD>
                <TD style={space}>
                  <EmptySpace height={10} />
                </TD>
                <TD style={space}>
                  ...
                  <br />
                  <EmptySpace height={1} />
                  <span>{formatTime(allowedCheckOutTime)}</span>
                </TD>
              </TR>
              <TR style={textStyle}>
                {/* <TD>
...
export default injectIntl(BookingConfirmationHost);
