...
class NewInquiry extends React.Component {
  ...
  render() {
    ...
    const {
      content: { checkIn, checkOut, personCapacity, startTime, endTime, logo },
    } = this.props;
            ...
            <TBody>
              <TR>
                <TD style={textStyle}>
                  ...
                  <EmptySpace height={20} />
                  <div>{`${formatMessage(
                    messages.newInjuryFrom
                  )} ${senderName}.`}</div>
                  <EmptySpace height={20} />
                  <div>
                    {`${formatMessage(
                      messages.tripStartDate
                    )} ${checkInDate} ${startTime}`}
                  </div>
                  <EmptySpace height={20} />
                  <div>
                    {`${formatMessage(
                      messages.tripEndDate
...
export default injectIntl(NewInquiry);
