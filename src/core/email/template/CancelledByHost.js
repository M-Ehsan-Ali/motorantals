            ...
            <TBody>
              <TR>
                <TD style={textStyle}>
                  ...
                  <EmptySpace height={20} />
                  <div>
                    `${formatMessage(messages.regretThatYourOwner)} ${hostName}{" "}
                    ${formatMessage(messages.canceledYourTrip)} $
                    {confirmationCode} $
                    ...
                    {refundToGuest > 0 && (
                      <span>
                        {" "}
                        <FormattedMessage
                          {...messages.willBeRefundedWithPolicy}
                        />{" "}
                        <CurrencyView
                          amount={refundToGuest}
                          currency={currency}
                        />{" "}
                        <FormattedMessage {...messages.andNotified} />
                      </span>
                    )}
                  </div>
...
export default injectIntl(CancelledByHost);
