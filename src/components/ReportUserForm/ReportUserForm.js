...
class ReportUserForm extends Component {
  ...
  render() {
    ...
    let isShow =
      formErrors.hasOwnProperty("syncErrors") &&
      formErrors["anyTouched"] &&
        ...
        <div>
          ...
          <div className={cx(cs.paddingBottom2, "customRatioButton")}>
            <label className={cx(cs.commonMediumText, s.displayGrid)}>
              ...
              />
              <FormattedMessage {...messages.reportContent1} /> {sitename}
            </label>
          </div>
          <div className={cx(cs.paddingBottom2, "customRatioButton")}>
            <label className={cx(cs.commonMediumText, s.displayGrid)}>
...
export default injectIntl(
  withStyles(s, cs)(connect(mapState, mapDispatch)(ReportUserForm))
);
