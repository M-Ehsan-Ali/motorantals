...
class RegisterForm extends Component {
  ...
  renderFormControl = ({
    ...
    return (
      <FormGroup
        className={cx(cs.spaceBottom3, cs.positionRelative)}
        id={input.name}
      >
        <label>{label}</label>
        <FormControl
        ...
        {type == "password" && (
          <span
            ...
            className={cx(cs.passwordIcon, "passwordIconRTL")}
          >
      ...
      <div className={cx(s.checkBoxGrid, cs.paddingBottom4)}>
        ...
        >
          ...
          <a
            href={"/privacy"}
            target={"blank"}
            className={cx(cs.siteLinkColor, cs.textTransformLowerCase)}
          >
            &nbsp;
  ...
  checkboxGroupMailing = ({
    ...
    return (
      <div className={cx(s.checkBoxGrid, cs.paddingBottom4)}>
        ...
        >
          <FormattedMessage {...messages.mailing} /> {` ${sitename}`}
        </p>
      </div>
    );
  };
  ...
  render() {
    ...
    return (
      <>
        ...
        <form
          onSubmit={handleSubmit(submit.bind(null, this.props.intl))}
          className={cx("noScroll", "inputFocusColor")}
        >
          <Field
            name="firstName"
            type="text"
          ...
          <Field name="mailing" component={this.checkboxGroupMailing} />
...
export default injectIntl(
  withStyles(s, cs, c)(connect(mapState, mapDispatch)(RegisterForm))
);
