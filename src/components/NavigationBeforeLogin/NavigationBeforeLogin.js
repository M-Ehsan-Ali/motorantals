    ...
    return (
      <div>
        ...
        <Nav pullRight className="normalHeader">
          ...
          <NavLink
            to="/"
            className={cx("hidden-lg", s.newMenuDesign, "borderNoneMb")}
          >
          ...
          {layoutType != 2 && (
            ...
            >
              {homeHeaderOnly && <img src={currencyIcon} />}
              {!homeHeaderOnly && <img src={currencyIconTwo} />}
            </NavLink>
          )}
          ...
          <NavLink
            to="http://support.motorentals.co"
            target="_blank"
            className={cx(s.breakPointScreen, "hidden-lg")}
          >
          ...
          <NavDropdown
            ...
            eventKey={3}
            title={<DropDownMenu homeHeaderOnly={homeHeaderOnly} />}
            noCaret
          ...
          >
            ...
            <NavLink to="http://support.motorentals.co" target="_blank">
              <FormattedMessage {...messages.help} />
            </NavLink>
          </NavDropdown>
        </Nav>
...
export default injectIntl(
  withStyles(s)(connect(mapState, mapDispatch)(NavigationBeforeLogin))
);
