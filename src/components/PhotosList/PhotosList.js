              ...
              <div key={key} className={s.positionRelative}>
                ...
                <div className="photoListDropDown">
                  ...
                  >
                    {(coverPhoto
                      ? coverPhoto != item.id
                      : listPhotos[0].id != item.id) && (
                      <MenuItem
                        eventKey="1"
                        onClick={() => this.changeCoverPhoto(item.id)}
                      >
                ...
                {(coverPhoto
                  ...
                  >
                    <img
                      src={TickIcon}
                      className={cx(s.tickIcon, "photoTickIconRTL")}
                    />
...
export default injectIntl(
  withStyles(s)(connect(mapState, mapDispatch)(PhotosList))
);
