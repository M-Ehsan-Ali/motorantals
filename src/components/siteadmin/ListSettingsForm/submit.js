...
async function submit(formatMessage, values, dispatch) {
  ...
  if(data.addListSettings.status === "success") {
    ...
    toastr.success(formatMessage(messages.addListSettings), formatMessage(messages.addListSettingsSuccess));
  } else {
      toastr.error(formatMessage(messages.addListSettings), formatMessage(messages.addListSettingsFail));
  }
