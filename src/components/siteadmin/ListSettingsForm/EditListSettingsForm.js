  ...
  render() {
    ...
    return (
      <div className={cx('maxwidthcenter', 'adminRadioBtn')}>
        ...
        <form onSubmit={handleSubmit(update.bind(null, formatMessage))}>
                ...
                <Row>
                  <Col xs={12} sm={12} md={12} lg={12} className={cx(cp.textAlignRight, 'textAlignLeftRTL')}>
                    ...
                    <div className={cx(cp.btnModalDelete, 'btnModalDeleteRTL')}>
                      <Button className={cx(cp.btnPrimaryBorder, cp.btnlarge, cp.fullWidth)} onClick={() => deleteListSettings(id, typeId, formatMessage)} disabled={submitting}>
