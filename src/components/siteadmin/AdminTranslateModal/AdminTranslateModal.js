...
class AdminTranslateModal extends React.Component {
    ...
    async handleSubmit(values) {
        ...
        if (data.updateTranslations.status === "success") {
            toastr.success(formatMessage(messages.translationUpdate), formatMessage(messages.commonChangesSuccess));
            this.props.closeAdminTranslateModal();
        } else {
            console.error(data.updateTranslations.status)
            toastr.error(formatMessage(messages.translationUpdate), formatMessage(messages.translationUpdateFail));
        }
        this.props.destroy();
    }
