...
class ListingManagement extends React.Component {
  ...
  async deleteListing(id, type) {
    ...
    await removeListing(id, type, formatMessage);
            ...
            data: <>
              {
                ...
                <a href="javascript:void(0)" onClick={() => removeListFromRecommended(value.id, currentPage, searchList, formatMessage)} >
                  <FormattedMessage {...messages.remove} />
                </a>
              }
              {
                value.recommend == null &&
                <a href="javascript:void(0)" onClick={() => addListToRecommended(value.id, currentPage, searchList, formatMessage)} >
