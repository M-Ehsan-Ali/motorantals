    ...
    return (
      <div className={cx(s.bookItPanel, "paypalCancelInput")}>
        <form onSubmit={handleSubmit(submit)}>
          ...
          <div className={cx(s.avatarImageGrid, cs.spaceBottom4)}>
            ...
            <div className={cx(s.textSection, "viewListingTextSectionRTL")}>
              ...
              >
                ...
                <span className={cs.siteLinkColor}>{hostName}</span>
              </a>
              <h4
                className={cx(
                  cs.commonContentText,
          ...
          {houseRules.length > 0 && (
            <>
              <HouseRules hostDisplayName={hostName} houseRules={houseRules} />
              <hr className={s.horizondalLine} />
            </>
          )}
          <div>
            ...
            <div>
              <label>
                <FormattedMessage {...messages.PaymentTypeText} />
              </label>
            </div>
          ...
          <div className={s.commonContentText}>
            <FormattedMessage {...messages.loginInfo} />
          </div>
          <div
            className={cx(
              cs.dFlexWrapAlignEnd,
              cs.paddingTop5,
              "arButtonLoader"
            )}
          >
...
export default injectIntl(
  withStyles(cs, s)(connect(mapState, mapDispatch)(PaymentForm))
);
