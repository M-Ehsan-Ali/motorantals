...
class HostActions extends Component {
  ...
  inquiry(guestDisplayName) {
    ...
    let next24Hours = moment(createdAt)
      .add(23, "hours")
      .add(59, "minutes");
          ...
          <p className={cx(s.actionPara, s.noMarginTop, cs.spaceBottom3)}>
            <FontAwesome.FaClockO
              className={cx(
                s.timeIconColor,
                s.timerIcon,
                s.rsFromMessageMarginRight,
                "rsFromMessageMarginRightRLT"
              )}
            />
      ...
      <div className={cx(s.actionInnerBox, s.actionContainer, cs.spaceBottom6)}>
        ...
        {listPublishStatus && (
          <div className={cx()}>
            ...
            <Button
              className={cx(s.btnPrimaryBorder, s.btnRight, "declineRTL")}
              disabled={loading}
  ...
  bookingConfirmed() {
    ...
    return (
      <div className={cx(s.actionInnerBox, s.actionContainer, cs.spaceBottom6)}>
        ...
        <div className={cx()}>
          <Link
            to={"/cancel/" + reservationId + "/owner"}
            className={cx(s.linkBtn, s.btnPrimary, s.linkInline)}
          >
  ...
  completed() {
    return (
      <div className={cx(s.actionInnerBox, s.actionContainer, cs.spaceBottom6)}>
        <h4 className={cx(s.noMarginTop, cs.spaceBottom2, s.actionHeading)}>
          <FormattedMessage {...messages.reservationCompleted1} />
        </h4>
        <p className={cx(s.actionPara, s.noMarginTop, s.marginBottom0)}>
...
export default injectIntl(
  withStyles(s, cs)(connect(mapState, mapDispatch)(HostActions))
);
