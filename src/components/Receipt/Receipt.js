  ...
  render() {
    ...
    if (!data) {
      ...
      const {
        data: {
          listData: {
            listingData: { checkInStart, checkInEnd },
          },
        },
      } = this.props;
      const {
        data: {
          listData: { settingsData },
        },
        refetch,
        currencyRates,
      } = this.props;
      ...
      const {
        data: { claimRefundedAt, claimTransaction },
      } = this.props;
      ...
      let createdDate = createdAt
        ...
        : "";
      let updatedDate = updatedAt
        ? moment(updatedAt).format("ddd, MMM DD, YYYY ")
        : "";
      let birthDate = dateOfBirth
        ? moment(dateOfBirth).format("MM/DD/YYYY")
        : "";
      let claimRefundedDate = claimRefundedAt
        ? moment(claimRefundedAt).format("ddd, MMM Do, YYYY ")
        : "";
      let checkInDate = checkIn
        ? moment(checkIn).format("ddd, MMM DD, YYYY ")
        : "";
      let checkOutDate = checkOut
        ? moment(checkOut).format("ddd, MMM DD, YYYY ")
        : "";
      let momentStartDate,
        momentEndDate,
        dayDifference,
        ...
        checkInTime,
        checkOutTime;
      let isSpecialPricingAssinged =
        bookingSpecialPricing && bookingSpecialPricing.length > 0
          ? true
          : false;
      let isAverage = 0,
        subTotal,
      ...
      let isDayTotal = 0,
        formattedStartTime,
        formattedEndTime,
        claimPaidAmount = claimTransaction?.amount,
        claimPaidCurrency = claimTransaction?.currency;
      modalInitialValues.securityDeposit = convert(
        currencyRates.base,
        currencyRates.rates,
        securityDeposit,
        currency,
      ...
      if (claimStatus && claimStatus != "pending") {
        modalInitialValues.claimAmount = convert(
          currencyRates.base,
          currencyRates.rates,
          claimAmount,
          currency,
      ...
      if (reservationState == "completed")
        checkOutDifference = moment().diff(moment(checkOut), "hour", true);
      if (cancellationDetails && reservationState == "cancelled") {
        let todayDiff = moment().diff(moment(checkIn), "hour", true);
        if (todayDiff > 0)
          checkOutDifference = moment().diff(
            moment(cancellationDetails.createdAt),
            "hour",
            true
          );
      }

      let showSecurityDeposit =
        userType === "owner" && securityDeposit <= 0 ? false : true;
        ...
        <Grid fluid className={cx(s.container, cs.spaceTop4)}>
          <Row>
            <Col lg={12} md={12} sm={12} xs={12}>
              ...
              <div
                className={cx(s.diplayFlex, cs.spaceTop5, s.fullWidthMobile)}
              >
              ...
              <div className={s.receiptGrid}>
                <div
                  className={cx(cs.spaceBottom4, {
                    [s.directionRTLPrint]: isRTL(locale),
                  })}
                >
                  <div className={s.mainSection}>
                    ...
                    >
                      <FormattedMessage {...messages.bookedBy} />:{" "}
                      {guestData.firstName}{" "}
                    </h6>
                    <h4
                      className={cx(
                    ...
                    <h5
                      className={cx(cs.commonMediumText, cs.fontWeightNormal)}
                    >
                      {createdDate}
                    </h5>
                    <hr
                      className={cx(
                        s.listingHorizoltalLine,
                        cs.spaceBottom3,
                        cs.spaceTop3
                      )}
                    />
                    <div>
                      ...
                      >
                        <FormattedMessage {...messages.vehicleDetails} />
                      </h3>
                      <div className={s.displayGridDetails}>
                        <div>
                          ...
                          >
                            <FormattedMessage {...messages.ownersName} />
                          </h4>
                          <a
                            href={"/users/show/" + hostData.profileId}
                            target={"_blank"}
                            className={cx(
                              cs.siteLinkColor,
                              cs.commonMediumText,
                    ...
                    <div>
                      ...
                      <div className={s.displayGridDetails}>
                        ...
                        <div>
                          ...
                          >
                            <FormattedMessage {...messages.travelDestination} />
                          </h6>
                          <p
                            className={cx(
                              cs.commonMediumText,
                      ...
                      >
                        <FormattedMessage {...messages.renterInfo} />
                      </h4>
                      <div className={s.displayGridDetails}>
                        <p
                          className={cx(
                        ...
                        >
                          <span
                            className={cx(
                              cs.fontWeightMedium,
                              s.infoDetailsPadding,
                              "receiptInfoDetailSpaceRTL"
                            )}
                          >
                        ...
                        >
                          ...
                          >
                            <FormattedMessage {...messages.licenseNumber} />:
                          </span>
                ...
                >
                  ...
                  >
                    ...
                    <div className={cx(s.diplayFlex, s.flexBillingSection)}>
                      ...
                      >
                        <div className={cx(s.specialPriceIcon, "hidden-print")}>
                          {isSpecialPricingAssinged && (
                            <span className={s.iconSection}>
                              <img
                                src={Faq}
                                className={cx(s.faqImage, "faqImageRTL")}
                              />
                            </span>
                          )}
                          <div
                        ...
                        <span
                          className={cx("directionLtr", cs.displayInlineBlock)}
                        >
                          <CurrencyConverter
                            amount={isAverage}
                            from={currency}
                    ...
                    {userType === "renter" &&
                      data.reservationState != "cancelled" && (
                        <>
                          ...
                          />
                          <div
                            className={cx(s.diplayFlex, s.flexBillingSection)}
                          >
                            <h5
                              className={cx(
                                cs.commonMediumText,
                      ...
                      cancellationDetails && (
                        <>
                          ...
                          >
                            ...
                            >
                              <FormattedMessage {...messages.actualEarnings} />
                            </h5>
                            <h6
                              className={cx(
                                cs.commonMediumText,
                  ...
                  {showSecurityDeposit && (
                    <div className={cx(s.mainSection, cs.spaceBottom4)}>
                      {userType === "renter" && (
                        <h4
                          className={cx(
                            cs.commonTotalText,
                      ...
                      {userType === "owner" && securityDeposit > 0 && (
                        <div>
                          <div className={cx(s.diplayFlex)}>
                            ...
                            >
                              <FormattedMessage
                                {...messages.securityDepositByRenter}
                              />
                            </h5>
                            <p
                              className={cx(
                          ...
                          {claimStatus == "pending" &&
                            ...
                            checkOutDifference < 24 && (
                              <div className={cs.spaceTop8}>
                                <span>
                                  <a
                                    className={cx(
                                      cs.siteLinkColor,
                      ...
                      {userType === "renter" &&
                        ["approved", "fullyRefunded"].includes(claimStatus) && (
                          <>
                            <div className={cx(s.diplayFlex, cs.spaceTop4)}>
                              ...
                              >
                                <FormattedMessage
                                  {...messages.refundedSecurityDeposit}
                                />
                              </h5>
                              <h6
                                className={cx(
                            ...
                            {securityDeposit > 0 && claimAmount > 0 && (
                              <div className={cs.spaceTop8}>
                                <a
                                  className={cx(
                                    cs.siteLinkColor,
...
export default injectIntl(
  withStyles(s, cs)(connect(mapState, mapDispatch)(PaymentReceipt))
);
