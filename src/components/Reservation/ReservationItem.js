...
import { Label, DropdownButton, Button } from "react-bootstrap";
  ...
  render() {
    ...
    let showDropdown =
      ...
      ((reservationState == "cancelled" &&
        cancellationDetails &&
        cancellationDetails.payoutToHost <= 0) ||
      ...
      <>
        {showModal && (
          <HostClaimModal
            ...
            claimed={Boolean(
              data && data.claimStatus && data.claimStatus != "pending"
            )}
          ...
          <div className={s.displayGrid}>
              ...
              <div>
                ...
                {reservationState &&
                  (reservationState === "approved" ||
                    ...
                    <div>
                      {phoneNumber && isPhoneVerified && countryCode && (
                        <a
                          href={
                            smallDevice && `tel:${countryCode}${phoneNumber}`
                          }
                          className={cx(
                            cs.siteLinkColor,
                            cs.fontWeightNormal,
                ...
                {!noList && (
                  ...
                  >
                    <img
                      src={chatIcon}
                      className={cx(s.iconSpace, "reservationIconSpaceRTL")}
                    />
            ...
            <div>
              ...
              >
                ...
                <span>
                  <span className={s.displayInlineBlock}>
                    {formattedStartTime}
                  </span>{" "}
                  <span>-</span>{" "}
                  <span className={s.displayInlineBlock}>
              ...
              {noList && userType === "renter" && (
                <span className={cx(cs.errorMessage, s.errorMsg)}>
                  {" "}
                  <FormattedMessage {...messages.noList} />{" "}
                </span>
              )}
              {noList && userType === "owner" && (
                <span className={cx(cs.errorMessage, s.errorMsg)}>
                  {" "}
                  <FormattedMessage {...messages.notexist} />{" "}
                </span>
              )}
              {!noList && (
                <>
            ...
            <div className={cx(cs.mobTextRight, "mobTextLeftRTL")}>
                ...
                <p className={cx(cs.fontWeightMedium, cs.commonSmallText)}>
                  {userType === "owner" ? (
                    <>
                      {reservationState === "completed" ? (
                        <>
                          <FormattedMessage {...messages.earningsLabel} />
                          {":"}
                        </>
                      ) : (
                        <FormattedMessage
                          {...messages.estimatedEarningsLabel}
                        />
                      )}{" "}
                      <CurrencyConverter
                        amount={subTotal}
              ...
              {userType === "owner" &&
                (reservationState == "cancelled" ||
                  ...
                  <>
                    <p className={cx(cs.fontWeightMedium, cs.commonSmallText)}>
                      <FormattedMessage {...messages.estimatedEarningsLabel} />{" "}
                      <CurrencyConverter
                    ...
                    <p className={cx(cs.fontWeightMedium, cs.commonSmallText)}>
                      <FormattedMessage {...messages.actualEarningsLabel} />{" "}
                      <CurrencyConverter
                        amount={
                          reservationState == "cancelled" && cancellationDetails
                            ? cancellationDetails.payoutToHost
                            : 0
                        }
                        className={s.bookItPrice}
                        from={currency}
              ...
              {!noList &&
                ...
                (reservationState == "completed" ||
                  ...
                  >
                    <Button
                      className={cx(cs.siteLinkColor, s.claimBtn)}
              ...
              >
                ...
                >
                  ...
                  {!noList && userType === "renter" && enableIternary && (
                    ...
                    >
                      <FormattedMessage {...messages.viewItinerary} />
                    </MenuItemLink>
                  )}
                  {!noList && userType === "renter" && (
                    <MenuItemLink to={"/users/trips/receipt/" + reservationId}>
...
export default injectIntl(
  withStyles(s, cs)(connect(mapState, mapDispatch)(ReservationItem))
);
