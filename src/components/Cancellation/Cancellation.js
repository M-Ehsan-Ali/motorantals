...
class CancellationPolicy extends React.Component {
  ...
  renderFormControlTextArea = ({
    ...
    return (
      <FormGroup>
        ...
        {touched && error && (
          <span className={cx(s.errorMessage, s.spaceInline)}>
            {formatMessage(error)}
          </span>
        )}
      </FormGroup>
  ...
  render() {
    ...
    let momentStartDate,
      ...
      starRatingValue = 0,
      keepReservationUrl =
        userType === "owner" ? "/reservation/current" : "/trips/current";
        ...
        <div>
          <Grid>
            <Row className={s.landingContaiconfirmationCodener}>
              <form onSubmit={handleSubmit(submit.bind(null, this.props.intl))}>
                <Col xs={12} sm={7} md={7} lg={7}>
                  ...
                  >
                    {userType === "owner" ? (
                      ...
                      <FormattedMessage {...messages.tripCancel} />
                    )}
                  </p>
                  <FormGroup>
                    <div className={cx(s.cancellationBtnSection, s.dFlex)}>
                      ...
                      >
                        {userType === "owner" ? (
                          ...
                          <FormattedMessage {...messages.keepYourTrip} />
                        )}
                      </Link>
                      ...
                      <Button
                        className={cx(
                          s.btnPrimary,
                          s.btnMediumSpace,
                          s.cancelReservationBtn
                        )}
                        onClick={() => this.handleCancel()}
                      >
                        {userType === "owner" ? (
                          <FormattedMessage
                            {...messages.cancelYourReservation}
                          />
                        ) : (
