                                        ...
                                        <ul className={cx(s.listType, s.space0, cs.dFlexWrapAlignEnd)}>
                                            <li>
                                                <Button 
                                                    ...
                                                    onClick={() => importiCal(item.listId, item.name, item.url, item.id, formatMessage)}
                                                > 
                                            ...
                                            <li>
                                                <Button 
                                                    className={s.iconContainer} 
                                                    onClick={() => deleteImportCal(item.listId, item.id, formatMessage)}
                                                > 
...
export default withStyles(s)(connect(mapState, mapDispatch)(injectIntl(CalendarsList)));