...
class ListPlaceStep1 extends Component {
  ...
  render() {
    ...
    return listingPages.includes(currentPage) ? (
      <div className={"inputFocusColor"}>
        {currentPage === "index" && (
          <ListIntro nextPage={this.nextPage} formPage={formPage} step={step} />
        )}
        {currentPage === "home" && (
          <ExistingPage1
            listId={listId}
        ...
        {currentPage === "review-how-renters-book" && (
          <ReviewGuestBook
            previousPage={this.previousPage}
            nextPage={this.nextPage}
            formPage={formPage}
